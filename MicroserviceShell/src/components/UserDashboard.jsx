...
const UserDashboard = () => {
  ...
  const loadUserDashboard = async () => {
    try {
      ...
      const [tasksResponse, notificationsResponse, statsResponse] =
        await Promise.all([
          fetch(`http://localhost:3000/api/tasks?assignedTo=${user.id}`, {
            headers,
          }),
          fetch(`http://localhost:3000/api/notifications?userId=${user.id}`, {
            headers,
          }),
          fetch(`http://localhost:3000/api/dashboard/user/${user.id}`, {
            headers,
          }),
        ]);
    ...
    return (
      <div className="user-dashboard">
        <div className="empty-state">
          ...
          <p>
            You need to be authenticated to view your tasks and notifications.
          </p>
        </div>
      </div>
    );
      ...
      <div className="dashboard-content">
            ...
            <div className="quick-navigation">
              ...
              <div className="navigation-cards">
                ...
                <div className="nav-card" onClick={() => navigate("/users")}>
                  ...
                  <button className="nav-button">Go to User Service</button>
                </div>
              </div>
            </div>
            ...
            <div className="notification-actions">
              ...
              <button
                onClick={async () => {
                  const headers = getAuthHeaders();
                  await fetch(
                    `http://localhost:3000/api/notifications/bulk-read`,
                    {
                      method: "POST",
                      headers,
        ...
        {activeTab === "demo" && (
          <div className="demo-tab">
            ...
            <p>
              Try these realistic scenarios to see how the microservices work
              together:
            </p>
            ...
            <div className="demo-scenarios">
              <div className="scenario-card">
                ...
                <p>
                  Creates a set of tasks for a 2-week sprint with assignments
                  and notifications
                </p>
              ...
              <div className="scenario-card">
                ...
                <p>
                  Simulates an urgent bug report that needs immediate attention
                </p>
              ...
              <div className="scenario-card">
                ...
                <p>
                  Creates tasks for code review and documentation before feature
                  release
                </p>
              ...
              <div className="scenario-card">
                ...
                <p>
                  Sets up comprehensive demo data with realistic user scenarios
                </p>{" "}
                <button
                  onClick={async () => {
                    const headers = getAuthHeaders();
                    await fetch(
                      "http://localhost:3000/api/notifications/demo/initialize",
                      {
                        method: "POST",
                        headers,
                      }
